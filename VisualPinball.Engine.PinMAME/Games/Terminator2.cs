...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class Terminator2 : Wpc
	{
		...
		protected override PinMameIdAlias[] Aliases { get; } = {
			...
			new PinMameIdAlias(34, CoilFlipperUpperRight, AliasType.Coil),
			new PinMameIdAlias(36, CoilFlipperUpperLeft, AliasType.Coil),
		};
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			new GamelogicEngineCoil(1) { Description = "Ball Popper" },
			new GamelogicEngineCoil(2) { Description = "Gun Kicker" },
			new GamelogicEngineCoil(3) { Description = "Outhole", DeviceHint = "^Trough\\s*\\d?", DeviceItemHint = "entry_coil" },
			new GamelogicEngineCoil(4) { Description = "Trough", DeviceHint = "^Trough\\s*\\d?", DeviceItemHint = "eject_coil" },
			new GamelogicEngineCoil(5) { Description = "Right Sling" },
			new GamelogicEngineCoil(6) { Description = "Left Sling" },
			new GamelogicEngineCoil(7) { Description = "Knocker" },
			new GamelogicEngineCoil(8) { Description = "Kickback" },
			new GamelogicEngineCoil(9) { Description = "Plunger", DeviceHint = "Plunger" },
			...
			new GamelogicEngineCoil(CoilFlipperLowerRight) { Description = "Lower Right Flipper", DeviceHint = "^RightFlipper$"},
			new GamelogicEngineCoil(CoilFlipperLowerLeft) { Description = "Lower Left Flipper", DeviceHint = "^LeftFlipper$"},

			new GamelogicEngineCoil(CoilFlipperUpperRight) { IsUnused = true },
			new GamelogicEngineCoil(CoilFlipperUpperLeft) { IsUnused = true },
		};
	}
}
