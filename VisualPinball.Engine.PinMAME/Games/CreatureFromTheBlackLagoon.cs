...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class CreatureFromTheBlackLagoon : Wpc
	{
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			new GamelogicEngineCoil(1) { Description = "Top Right Popper" },
			new GamelogicEngineCoil(2) { Description = "Left Subway Enter Flasher", IsLamp = true },
			new GamelogicEngineCoil(3) { Description = "Lower Right Popper" },
			new GamelogicEngineCoil(4) { Description = "Trough Eject", DeviceHint = "^Trough\\s*\\d?", DeviceItemHint = "eject_coil" },
			new GamelogicEngineCoil(5) { Description = "Right Slingshot" },
			new GamelogicEngineCoil(6) { Description = "Left Slingshot" },
			new GamelogicEngineCoil(7) { Description = "Knocker" },
			new GamelogicEngineCoil(8) { Description = "Bottom Right Flasher", IsLamp = true },
			new GamelogicEngineCoil(9) { Description = "Back Flashers", IsLamp = true },
