...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class StarTrekEnterprise : Sam
	{
		...
		protected override GamelogicEngineSwitch[] Switches { get; } = {
			new GamelogicEngineSwitch(1) { Description = "(Beam) Me Up" },
			new GamelogicEngineSwitch(2) { Description = "Beam (Me) Up" },
			new GamelogicEngineSwitch(4) { Description = "Beam Me (Up)" },
			new GamelogicEngineSwitch(7) { Description = "Right 3-Bank Target (Top)" },
			new GamelogicEngineSwitch(8) { Description = "Right 3-Bank Target (Center)" },
			new GamelogicEngineSwitch(9) { Description = "Right 3-Bank Target (Bottom)" },
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			...
			new GamelogicEngineCoil(3) { Description = "Magnet" },
			new GamelogicEngineCoil(4) { Description = "Center Drop Target Up" },
			new GamelogicEngineCoil(5) { Description = "Center Drop Target Down" },
			new GamelogicEngineCoil(6) { Description = "Left Eject" },
			new GamelogicEngineCoil(7) { Description = "Vengeance Kick Back" },
