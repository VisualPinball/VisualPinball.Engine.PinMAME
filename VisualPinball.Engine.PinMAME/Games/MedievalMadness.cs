...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class MedievalMadness : Wpc
	{
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			...
			new GamelogicEngineCoil(4) { Description = "Castle" },
			new GamelogicEngineCoil(5) { Description = "Castle Gate (Power)" },
			new GamelogicEngineCoil(6) { Description = "Castle Gate (Hold)" },
			new GamelogicEngineCoil(7) { Description = "Knocker" },
			new GamelogicEngineCoil(8) { Description = "Catapult" },
			new GamelogicEngineCoil(9) { Description = "Right Eject" },
