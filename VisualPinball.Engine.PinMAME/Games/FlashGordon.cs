...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class FlashGordon : Bally
	{
		...
		protected override GamelogicEngineSwitch[] Switches { get; } = {
			new GamelogicEngineSwitch(1) { Description = "2 Left & Right R.O. Buttons" },
			new GamelogicEngineSwitch(2) { Description = "3 Shooter Lane R.O. Buttons" },
			new GamelogicEngineSwitch(3) { Description = "Top Single Drop Target" },
			new GamelogicEngineSwitch(4) { Description = "Shooter Lane Rollover" },
			new GamelogicEngineSwitch(5) { Description = "Drop Target 50 Point Reb. (2)" },
			new GamelogicEngineSwitch(6) { Description = "Credit Button" },
			new GamelogicEngineSwitch(7) { Description = "Tilt (3)" },
			new GamelogicEngineSwitch(8) { Description = "Outhole" },
			new GamelogicEngineSwitch(9) { Description = "Coin III (right)" },
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			new GamelogicEngineCoil(1) { Description = "Drop Target Reset" },
			new GamelogicEngineCoil(2) { Description = "Drop Target Reset" },
			new GamelogicEngineCoil(3) { Description = "In Line Drop Target" },
			new GamelogicEngineCoil(4) { Description = "Saucer Kick Down" },
			new GamelogicEngineCoil(6) { Description = "Knocker" },
			new GamelogicEngineCoil(7) { Description = "Out Hole" },
			new GamelogicEngineCoil(8) { Description = "Saucer Kick Up" },
			new GamelogicEngineCoil(9) { Description = "Single Drop Target Reset" },
			new GamelogicEngineCoil(10) { Description = "Left Bumper" },
			new GamelogicEngineCoil(11) { Description = "Right Bumper" },
			new GamelogicEngineCoil(12) { Description = "Single Drop Target Pull Down" },
			new GamelogicEngineCoil(13) { Description = "Top Bumper" },
			new GamelogicEngineCoil(14) { Description = "Left Slingshot" },
			new GamelogicEngineCoil(15) { Description = "Right Slingshot" },
			new GamelogicEngineCoil(18) { Description = "Coin Lockout Door" },
			new GamelogicEngineCoil(19) { Description = "KI Relay (Flipper enabled)" },
		};
	}
}
