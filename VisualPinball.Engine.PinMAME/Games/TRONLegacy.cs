...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class TRONLegacy : Sam
	{
		...
		protected override GamelogicEngineSwitch[] Switches { get; } = {
			new GamelogicEngineSwitch(1) { Description = "TRO(N)" },
			new GamelogicEngineSwitch(2) { Description = "TR(O)N" },
			new GamelogicEngineSwitch(3) { Description = "T(R)ON" },
			new GamelogicEngineSwitch(4) { Description = "(T)RON" },
			new GamelogicEngineSwitch(7) { Description = "(Z)USE" },
			new GamelogicEngineSwitch(8) { Description = "Z(U)SE" },
		...
		public override GamelogicEngineLamp[] AvailableLamps { get; } = {
			new GamelogicEngineLamp(1) { Description = "TRO(N)" },
			new GamelogicEngineLamp(2) { Description = "TR(O)N" },
			new GamelogicEngineLamp(3) { Description = "T(R)ON" },
			new GamelogicEngineLamp(4) { Description = "(T)RON" },
			new GamelogicEngineLamp(5) { Description = "Tron Double Scoring" },
			new GamelogicEngineLamp(6) { Description = "Bumpers" },
			new GamelogicEngineLamp(7) { Description = "Spinners" },
			new GamelogicEngineLamp(8) { Description = "Left Outlane" },
			new GamelogicEngineLamp(9) { Description = "(C)LU" },
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			...
			new GamelogicEngineCoil(3) { Description = "4-Bank Drop Target" },
			new GamelogicEngineCoil(4) { Description = "Video Game Eject" },
			new GamelogicEngineCoil(5) { Description = "Disc Motor Power" },
			new GamelogicEngineCoil(6) { Description = "Recognizer 3-Bank Motor / Relay" },
			new GamelogicEngineCoil(7) { Description = "Orbit Up / Down Post" },
