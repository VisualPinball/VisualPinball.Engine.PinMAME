...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class TheWalkingDead : Sam
	{
		...
		protected override GamelogicEngineSwitch[] Switches { get; } = {
			...
			new GamelogicEngineSwitch("09") { Description = "Left 3-Bank #1 (Bottom)" },
		...
		public override GamelogicEngineLamp[] AvailableLamps { get; } = {
			new GamelogicEngineLamp("01") { Description = "Start Button" },
			new GamelogicEngineLamp("02") { Description = "Tournament Start Button" },
			new GamelogicEngineLamp("03") { Description = "12X Playfield values" },
			new GamelogicEngineLamp("04") { Description = "Shoot Again" },
			new GamelogicEngineLamp("05") { Description = "4 Walkers Killed" },
			new GamelogicEngineLamp("06") { Description = "3 Walkers Killed" },
			new GamelogicEngineLamp("07") { Description = "2 Walkers Killed" },
			new GamelogicEngineLamp("08") { Description = "1 Walker Killed" },
			new GamelogicEngineLamp("09") { Description = "40 Walkers Killed" },
			...
			new GamelogicEngineLamp("24", 168) { Description = "Right Loop Arrow Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("24", 169) { Description = "Right Loop Arrow Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("24", 170) { Description = "Right Loop Arrow Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("33", 195) { Description = "Left Loop Arrow Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("33", 196) { Description = "Left Loop Arrow Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("33", 197) { Description = "Left Loop Arrow Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("36", 203) { Description = "Left Ramp Arrow Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("36", 204) { Description = "Left Ramp Arrow Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("36", 205) { Description = "Left Ramp Arrow Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("41", 152) { Description = "Right Ramp Arrow Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("41", 153) { Description = "Right Ramp Arrow Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("41", 154) { Description = "Right Ramp Arrow Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("57", 187) { Description = "Center Lane Arrow Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("57", 188) { Description = "Center Lane Arrow Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("57", 189) { Description = "Center Lane Arrow Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("79", 136) { Description = "Star Rollover (Bottom) Red", Type = LampType.RgbMulti, Channel = ColorChannel.Red },
			new GamelogicEngineLamp("79", 137) { Description = "Star Rollover (Bottom) Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("79", 138) { Description = "Star Rollover (Bottom) Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("80", 134) { Description = "Star Rollover (Top) Green", Type = LampType.RgbMulti, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("80", 135) { Description = "Star Rollover (Top) Blue", Type = LampType.RgbMulti, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("gi", 107) { Description = "GI (Green)", Type = LampType.RgbMulti, Source = LampSource.GI, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("gi", 108) { Description = "GI (Blue)", Type = LampType.RgbMulti, Source = LampSource.GI, Channel = ColorChannel.Blue },
			...
			new GamelogicEngineLamp("gi_slings", 114) { Description = "GI: Slings (Green)", Type = LampType.RgbMulti, Source = LampSource.GI, Channel = ColorChannel.Green },
			new GamelogicEngineLamp("gi_slings", 149) { Description = "GI: Slings (Blue)", Type = LampType.RgbMulti, Source = LampSource.GI, Channel = ColorChannel.Blue },
		};
