...
namespace VisualPinball.Engine.PinMAME.Games
{
	...
	public class AttackFromMars : Wpc
	{
		...
		protected override GamelogicEngineCoil[] GameCoils { get; } = {
			new GamelogicEngineCoil(1) { Description = "Auto Plunger", DeviceHint = "Plunger", DeviceItemHint = "c_autofire" },
			new GamelogicEngineCoil(2) { Description = "Trough Eject", DeviceHint = "^Trough\\s*\\d?", DeviceItemHint = "eject_coil" },
			new GamelogicEngineCoil(3) { Description = "Left Popper" },
			new GamelogicEngineCoil(4) { Description = "Right Popper" },
			new GamelogicEngineCoil(5) { Description = "Left Alien Low" },
			new GamelogicEngineCoil(6) { Description = "Left Alien High" },
			new GamelogicEngineCoil(7) { Description = "Knocker" },
			new GamelogicEngineCoil(8) { Description = "Right Alien High" },
			new GamelogicEngineCoil(9) { Description = "Left Slingshot" },
