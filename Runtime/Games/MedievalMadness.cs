...
{
	public class MedievalMadness : IPinMameGame
	{
		public string Name { get; } = "Medieval Madness";
		public int Year { get; } = 1997;
		public string Manufacturer { get; } = "Williams";
		public int IpdbId { get; } = 4032;
