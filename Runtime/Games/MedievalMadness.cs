...
namespace VisualPinball.Unity
{
	...
	public class MedievalMadness : PinMameGame
	{
		...
		public override GamelogicEngineCoil[] AvailableCoils { get; } = {
			...
			new GamelogicEngineCoil("17") { Description = "Left Side Low Flashers" },
			new GamelogicEngineCoil("18") { Description = "Left Ramp Flashers" },
			new GamelogicEngineCoil("19") { Description = "Left Side High Flashers" },
			new GamelogicEngineCoil("20") { Description = "Right Side High Flashers" },
			new GamelogicEngineCoil("21") { Description = "Right Ramp Flashers" },
			new GamelogicEngineCoil("22") { Description = "Castle Right Side Flashers" },
			new GamelogicEngineCoil("23") { Description = "Right Side Low Flashers" },
			new GamelogicEngineCoil("24") { Description = "Moat Flashers" },
			new GamelogicEngineCoil("25") { Description = "Castle Left Side Flashers" },
